...
class NonNotifications extends StatefulWidget {
  const NonNotifications({Key? key}) : super(key: key);

  @override
  State<NonNotifications> createState() => _NonNotificationsState();
}

class _NonNotificationsState extends State<NonNotifications> {
