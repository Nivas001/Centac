...
import '../Extra/ViewMarkNon.dart';

//User? user = FirebaseAuth.instance.currentUser;

class NonUser1 extends StatefulWidget {
  const NonUser1({Key? key}) : super(key: key);

  @override
  State<NonUser1> createState() => _NonUser1State();
}

class _NonUser1State extends State<NonUser1> {
